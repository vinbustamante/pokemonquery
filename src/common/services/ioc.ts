...
export function configureCommonServices(container: Container): Container {
  ...
  container
    .bind<IUtilService>(commonServiceTypes.IUtilService)
    .to(UtilService)
    .inSingletonScope();
  ...
  container
    .bind<IDateService>(commonServiceTypes.IDateService)
    .to(DateService)
    .inSingletonScope();
  container
    .bind<IHttpService>(commonServiceTypes.IHttpService)
    .to(HttpService)
    .inSingletonScope();
  container
    ...
    .inSingletonScope();
  container
    .bind<IPokemonService>(commonServiceTypes.IPokemonService)
    .to(PokemonCacheableService)
    .inSingletonScope();
  container
    .bind<IEncounterService>(commonServiceTypes.IEncounterService)
    .to(EncounterService)
    .inSingletonScope();
  container
    .bind<IFlowService>(commonServiceTypes.IFlowService)
    .to(FlowService)
    .inSingletonScope();
  container
